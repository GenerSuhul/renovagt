...
CREATE INDEX idx_products_sap ON public.products(sap_item_code);
...
CREATE INDEX idx_banners_placement ON public.promotional_banners(placement);
...
CREATE INDEX idx_intq_status ON public.integration_event_queue(status, scheduled_at);
...
CREATE INDEX idx_notifications_account ON public.notifications(customer_account_id);
